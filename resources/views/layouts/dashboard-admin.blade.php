...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/feather-icons/4.28.0/feather.min.js" crossorigin="anonymous">
        < script src = "https://kit.fontawesome.com/109fcdeef4.js"
...
<body class="nav-fixed">
                    ...
                    <div class="page-header-content pt-4">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mt-4">
                                ...
                                <div class="page-header-subtitle">Panel de control del Administrador, usalo bien.
                                    :)</div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-8 col-xxl-12">
                                        <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                            <h1 class="text-primary">¡Bienvenido a Datasignt!</h1>
                                            <p class="text-gray-700 mb-0">Datasignt es una aplicación web que en
                                                futuro apoyara los procesos de gestión de hospitales y clinicas,
                                                trayendo mejor rendimiento en los procesos de salud de los clientes.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-xxl-12 text-center"><img class="img-fluid"
                                            src="{{ asset('libs/sb-admin/assets/img/illustrations/at-work.svg') }}"
    ...
    <script src="{{ asset('libs/sb-admin/assets/demo/chart-area-demo.js') }}"></script>
    <script src="{{ asset('libs/sb-admin/assets/demo/chart-bar-demo.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
    <script src="{{ asset('libs/sb-admin/js/datatables/datatables-simple-demo.js') }}"></script>
    <script src="https://cdn.jsdelivr.net/npm/litepicker/dist/bundle.js" crossorigin="anonymous"></script>
    <script src="{{ asset('libs/sb-admin/js/litepicker.js') }}"></script>
</body>
